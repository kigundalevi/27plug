...
///      * Controls.
class CustomFlickVideoWithControls extends StatefulWidget {
  const CustomFlickVideoWithControls({
    Key? key,
    this.controls,
...
class _CustomFlickVideoWithControlsState
    extends State<CustomFlickVideoWithControls> {
          ...
          child: Container(
            ...
            child: DefaultTextStyle(
              ...
              child: Stack(
                children: <Widget>[
                  Center(
                    child: CustomFlickNativeVideoPlayer(
                      videoPlayerController: _videoPlayerController,
                      fit: widget.videoFit,
