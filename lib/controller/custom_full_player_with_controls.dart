import 'package:africanplug/controller/custom_full_player.dart';
import 'package:africanplug/controller/custom_player.dart';
...
///      * Controls.
class CustomFullFlickVideoWithControls extends StatefulWidget {
  const CustomFullFlickVideoWithControls({
    Key? key,
    this.controls,
  ...
  @override
  _CustomFlickVideoWithControlsState createState() =>
      _CustomFlickVideoWithControlsState();
}

class _CustomFlickVideoWithControlsState
    extends State<CustomFullFlickVideoWithControls> {
        ...
        return Container(
          ...
          child: DefaultTextStyle(
            ...
            child: Stack(
              children: <Widget>[
                Center(
                  child: CustomFullFlickNativeVideoPlayer(
                    videoPlayerController: _videoPlayerController,
                    fit: widget.videoFit,
